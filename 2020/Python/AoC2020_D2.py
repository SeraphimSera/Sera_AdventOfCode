...
passwords = [line.split(": ") for line in passwords.splitlines()]
...
for policy, password in passwords:
    ...
    # Part 2
    left, right = list(map(lambda x: x-1, _range))

    # Just for future reference, this does an XOR check
    if letter in (password[left], password[right]) and password[left] != password[right]:
        valid_2 += 1


print(f"There are {valid_1} valid passwords in part 1's system.")
print(f"There are {valid_2} valid passwords in part 2's system.")
