...
for group in _input.split("\n\n"):
    ...
    # Part 2
    common = set.intersection(*[set(person) for person in group.splitlines()])
    count_2 += len(common)

print(f"The number of all questions that anyone in any group answered yes to was {count_1}.")
print(f"The number of all questions that everyone in any group answered yes to was {count_2}.")
